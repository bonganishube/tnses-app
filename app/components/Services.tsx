...
const services: Service[] = [
  {
    ...
    accent: "bg-secondaryColor text-white",
    image: Image1,
  },
  {
    icon: BookOpenText,
  ...
  return (
    ...
    >
      ...
      >
        <span
          className={cn(
            "mb-6 flex w-max rounded-xl p-3 shadow-soft transition-transform duration-300 group-hover:scale-105",
            service.accent,
            featured && "bg-secondaryColor-700"
          )}
        >
        ...
        <AlertDialog>
          ...
          <AlertDialogContent className="rounded-2xl">
            <AlertDialogHeader>
              <span
                className={cn(
                  "mb-2 flex w-max rounded-xl p-3 shadow-soft",
                  service.accent
                )}
              >
                <Icon className="h-5 w-5" />
              </span>
              <AlertDialogTitle className="text-xl tracking-tight text-secondaryColor">
                {service.title}
              </AlertDialogTitle>
      ...
      {service.image ? (
        <div className="relative hidden md:block md:w-1/2">
          ...
          />
          <div className="absolute inset-0 bg-gradient-to-r from-secondaryColor/60 to-transparent" />
        </div>
      ) : null}
    </div>
  );
